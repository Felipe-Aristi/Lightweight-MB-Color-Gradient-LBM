...
// Grid
inline constexpr label_t NX = static_cast<label_t>(256);
inline constexpr label_t NZ = static_cast<label_t>(256);
...
// Bubble parameters
inline constexpr real_t bubble_radius = static_cast<real_t>(20.0);
